...
<body background="https://i.ebayimg.com/images/g/FR8AAOSwQJ5UUFgL/s-l300.jpg" style="background-attachment: fixed;">
    ...
    <center>
        <br><br><br><br>
        <div class="head1" >Cleanliness of Store</div>
        <br><br><br><br>
        <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/4/49/Pictograms-nps-litter_receptacle.svg/1024px-Pictograms-nps-litter_receptacle.svg.png" class="tab-image main_image">
