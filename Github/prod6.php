...
<body background="https://i.ebayimg.com/images/g/FR8AAOSwQJ5UUFgL/s-l300.jpg" style="background-attachment: fixed;">
    ...
    <center>
        <br><br><br><br>
        <div class="head1" >Any Other</div>
        <br><br><br><br>
        <img src="https://cdn3.iconfinder.com/data/icons/toolbar-people/512/user_problem_man_male_person_profile-512.png" class="tab-image main_image">
        
        
    </center>
        <div class="box2">
     <form method="POST" name="RegForm" action="truckdb.php">
